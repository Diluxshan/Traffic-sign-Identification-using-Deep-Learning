...
ap.add_argument("-d", "--dataset", required=True, help="path to input dataset of the image")

ap.add_argument("-m", "--model", required=True, help="path to output model")

ap.add_argument("-p", "--plot", type=str, default="plot.png", help="path to training history plot")

ap.add_argument("-ep", "--epoches", required=True, help="Number of Epoches")

ap.add_argument("-bs", "--batchsize", required=True, help="Number of Batch Size")

args = vars(ap.parse_args())

print(args)
print(int(args['epoches']))
